...
export default function Locations() {
  return (
    <section id="locations" className="py-24 sm:py-32 bg-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8">
          {offices.map((office) => (
            <article
              key={office.city}
              className={`relative bg-white border border-primary/10 rounded-3xl p-7 sm:p-8 lg:p-10 flex flex-col ${
                office.featured
            ...
            >
              ...
              <p className="mt-2 text-secondary text-xs uppercase tracking-[0.16em] font-semibold">
                {office.region}
              </p>
